...
DEFAULT_NEW_UNC_NAME = "train_uncertainty_map_statue_alex01370.png"


def main(new_unc_path: str | None = None) -> None:
    if new_unc_path is None:
        new_unc_path = os.path.join(base_path, "uncertainty", DEFAULT_NEW_UNC_NAME)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Visualize error and uncertainty heatmaps.")
    parser.add_argument("--new_unc_path", help="Path to new uncertainty map")
    args = parser.parse_args()
    main(args.new_unc_path)
