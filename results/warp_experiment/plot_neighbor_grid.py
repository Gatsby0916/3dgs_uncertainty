...
scenes = [
    ("Basket", "results/warp_experiment/basket_neighbor"),
    ("Statue", "results/warp_experiment/statue_neighbor"),
    ("Torch", "results/warp_experiment/torch_neighbor"),
    ("Africa", "results/warp_experiment/africa_neighbor")
]

fig, axes = plt.subplots(4, 4, figsize=(16, 9)) # 4 rows, 4 cols
...
plt.savefig("results/warp_experiment/combined_neighbor_grid.png", dpi=150, bbox_inches='tight', pad_inches=0.0)
print("Saved results/warp_experiment/combined_neighbor_grid.png")
